...
class CartStore {
  constructor() {
    ...
    this.bindListeners({
      handleAddToCart: InstagramPhotosActions.ADD_TO_CART,
      handleRemoveFromCard: InstagramPhotosActions.REMOVE_FROM_CART,
      handleClearCart: InstagramPhotosActions.CLEAR_CART
    });
